const createRecipeData = {
  ...
  effects: [
    "What does this creation do, ie. 'This sword does 1d6 fire damage', or 'this potion makes the drinker float a few inches off the ground for 1d6 days'",
  ],
  lore: [
    "Are there any interesting facts about this creation?",
  ],
  ingredients: [
    {
