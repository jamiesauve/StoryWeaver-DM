...
const people = {
  ...
  'indabara': {
    ...
    description: [
      `Elberara is a sniffy, elderly herbalist. She is judgmental of others, particularly outlandish races. She has long, thin white hair and deep blue skin, and wears dusky green robes.`,
    ]
  },
  'alturas': {
    name: 'alturas',
